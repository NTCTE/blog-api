...
return [
    ...
    | валидатора. Некоторые из этих правил имеют несколько версий, такие
    | как правила размера. Не стесняйтесь изменять эти сообщения здесь.
    |
    */
    ...
    */
    ...
    | на что-то более читабельное, например, "Адрес электронной почты" вместо
